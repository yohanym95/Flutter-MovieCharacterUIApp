...
class CharacterBlackPantherDetailScreen extends StatefulWidget {
  final CharacterBlackPanther character;
  ...
  const CharacterBlackPantherDetailScreen({Key key, this.character}) : super(key: key);

  @override
  _CharacterBlackPantherDetailScreenState createState() => _CharacterBlackPantherDetailScreenState();
}

class _CharacterBlackPantherDetailScreenState extends State<CharacterBlackPantherDetailScreen> with AfterLayoutMixin<CharacterBlackPantherDetailScreen> {
