...
class CharacterAvengerDetailScreen extends StatefulWidget {
  final CharacterAvengers character;
  ...
  const CharacterAvengerDetailScreen({Key key, this.character}) : super(key: key);

  @override
  _CharacterAvengerDetailScreenState createState() => _CharacterAvengerDetailScreenState();
}

class _CharacterAvengerDetailScreenState extends State<CharacterAvengerDetailScreen> with AfterLayoutMixin<CharacterAvengerDetailScreen>{
