...
class CharacterMinionsDetailsScreen extends StatefulWidget {
  final CharacterMinons character;
  ...
  const CharacterMinionsDetailsScreen({Key key, this.character}) : super(key: key);

  @override
  _CharacterMinionsDetailsScreenState createState() => _CharacterMinionsDetailsScreenState();
}

class _CharacterMinionsDetailsScreenState extends State<CharacterMinionsDetailsScreen> with AfterLayoutMixin<CharacterMinionsDetailsScreen>{
