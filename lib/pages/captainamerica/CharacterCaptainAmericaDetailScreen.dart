...
class CharacterCaptainAmericaDetailScreen extends StatefulWidget {
  final CharacterCaptainAmerica character;
  ...
  const CharacterCaptainAmericaDetailScreen({Key key, this.character}) : super(key: key);

  @override
  _CharacterCaptainAmericaDetailScreenState createState() => _CharacterCaptainAmericaDetailScreenState();
}

class _CharacterCaptainAmericaDetailScreenState extends State<CharacterCaptainAmericaDetailScreen> with AfterLayoutMixin<CharacterCaptainAmericaDetailScreen>{
