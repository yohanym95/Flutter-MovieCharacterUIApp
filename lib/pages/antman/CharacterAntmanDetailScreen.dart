...
class CharacterAntmanDetailScreen extends StatefulWidget {
  ...
  const CharacterAntmanDetailScreen({Key key, this.character}) : super(key: key);

  @override
  _CharacterAntmanDetailScreenState createState() => _CharacterAntmanDetailScreenState();
}

class _CharacterAntmanDetailScreenState extends State<CharacterAntmanDetailScreen> with AfterLayoutMixin<CharacterAntmanDetailScreen> {
