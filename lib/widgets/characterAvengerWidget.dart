...
import 'package:flutter_uitest1/pages/avengers/charcaterAvengersdetailsScreen.dart';

import '../styleguide.dart';

class CharacterAvengerWidget extends StatelessWidget {
  final CharacterAvengers character;
  final PageController pageController;
  final int currentPage;

  const CharacterAvengerWidget(
      ...
      onTap: () {
        Navigator.push(
            ...
            PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => CharacterAvengerDetailScreen(
                    character:
