...
import 'package:flutter_uitest1/pages/des/Character_detail_screen.dart';
import 'package:flutter_uitest1/pages/minions/CharacterMinons_details.dart';

import '../styleguide.dart';

class CharacterMinionWidget extends StatelessWidget {
  final CharacterMinons character;
  final PageController pageController;
  final int currentPage;

  const CharacterMinionWidget(
      ...
      onTap: () {
        Navigator.push(
            ...
            PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => CharacterMinionsDetailsScreen(
                    character:
